<script lang="ts">
  ...
  export let href = "#consultation";
</script>

<div class="bg-black text-white text-[11px] font-medium py-3 px-4 flex justify-between items-center tracking-wide">
  <div class="flex-1 text-center">
    <span class="opacity-90">Serving Oklahoma businesses, agents, homeowners & builders — Technology, media, and real estate solutions</span>
  </div>
