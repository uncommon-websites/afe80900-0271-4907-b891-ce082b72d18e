...
<section class="bg-[#f9f9f7] pb-24 px-6" id="projects">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
      ...
      <div class="relative h-[400px] rounded-2xl overflow-hidden group cursor-pointer">
        ...
        <div class="absolute inset-0 bg-black/30 p-8 flex flex-col justify-between">
          <h3 class="text-white text-2xl font-light max-w-[250px]">See our smart home installations. <br>View projects -></h3>
        </div>
      </div>
      ...
      <div class="relative h-[400px] rounded-2xl overflow-hidden group cursor-pointer">
        ...
        />
        <div class="absolute inset-0 bg-black/30 p-8 flex flex-col justify-between">
          <h3 class="text-white text-2xl font-light max-w-[300px]">Learn how we integrate smart technology seamlessly. <br>How it works -></h3>
        </div>
      </div>
    </div>
