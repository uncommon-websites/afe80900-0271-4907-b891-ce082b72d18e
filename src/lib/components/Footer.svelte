...
<footer class="bg-[#f9f9f7] pt-12 pb-12 px-6">
  <div class="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
    <div>
      <h3 class="font-medium text-gray-900 mb-4">Leios Consulting</h3>
      <ul class="space-y-2 text-sm text-gray-500">
        ...
        <li><a href="#projects" class="hover:text-gray-900">Projects</a></li>
        <li><a href="#" class="hover:text-gray-900">For Builders</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm text-gray-500">
        <li><a href="#services" class="hover:text-gray-900">Smart Home Automation</a></li>
        <li><a href="#services" class="hover:text-gray-900">Network Optimization</a></li>
        <li><a href="#services" class="hover:text-gray-900">Professional Media</a></li>
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm text-gray-500">
        ...
        <li><a href="#consultation" class="hover:text-gray-900">Free Consultation</a></li>
    ...
    <div>
      <h3 class="font-medium text-gray-900 mb-4">Stay Updated</h3>
      <p class="text-xs text-gray-500 mb-4">Get smart home tips and project updates.</p>
      ...
      <div class="mt-8">
        <h4 class="font-medium text-gray-900 text-sm mb-2">Newsletter</h4>
  ...
  <div class="max-w-[1200px] mx-auto mt-24 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400">
    <p>© 2024 Leios Consulting. All rights reserved.</p>
